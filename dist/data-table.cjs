...
function SortIcon({ active, direction }) {
  if (!active || !direction) return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react.ChevronsUpDown, { className: "ml-1 h-3.5 w-3.5 opacity-40" });
  return direction === "asc" ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react.ChevronUp, { className: "ml-1 h-3.5 w-3.5 text-primary" }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react.ChevronDown, { className: "ml-1 h-3.5 w-3.5 text-primary" });
}
...
function DataTableInternal({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { ref, className: cn("w-full", className), ...props, children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "rounded-md border", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(Table, { "aria-busy": isLoading, children: [
      caption ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(TableCaption, { children: caption }) : null,
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(TableHeader, { children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(TableRow, { className: "hover:bg-transparent", children: columns.map((col) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          TableHead,
          {
            ...
            children: isSortable ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
              "button",
              {
                type: "button",
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: col.header }),
            ...
            ) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "flex items-center", children: col.header })
          },
          col.key
        );
      }) }) }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(TableBody, { children: [
        isLoading && Array.from({ length: skeletonRows }).map((_, i) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(TableRow, { className: "hover:bg-transparent", children: columns.map((col) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(TableCell, { className: col.className, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Skeleton, { className: "h-4 w-full rounded" }) }, col.key)) }, i)),
        !isLoading && data.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(TableRow, { className: "hover:bg-transparent", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(TableCell, { colSpan: columns.length, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-col items-center justify-center gap-2 py-12 text-muted-foreground", children: [
          emptyIcon ?? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            "svg",
            {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "text-sm", children: emptyMessage })
        ] }) }) }),
        !isLoading && data.length > 0 && data.map((row, i) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          TableRow,
          {
            className: cn(
            ...
            "data-state": void 0,
            children: columns.map((col) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(TableCell, { className: col.className, children: col.cell ? col.cell(row, i) : renderCellValue(row[col.key]) }, col.key))
          },
          rowKey ? rowKey(row, i) : i
        ))
      ] })
    ] }) }),
    pagination && totalPages > 1 && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "mt-3 flex items-center justify-between gap-2 text-sm text-muted-foreground", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "shrink-0 tabular-nums", children: [
        Math.min((pagination.page - 1) * pagination.pageSize + 1, pagination.total),
        "\u2013",
        Math.min(pagination.page * pagination.pageSize, pagination.total),
        " ",
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "hidden sm:inline", children: [
          "of ",
          pagination.total
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center gap-1", children: [
        ...
        (() => {
          ...
          return pages.map(
            (p, i) => p === "\u2026" ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "px-1 text-xs select-none", children: "\u2026" }, `ellipsis-${i}`) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
              "button",
              {
                type: "button",
