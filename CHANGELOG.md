...
### Added
- Updated the root package to pin and distribute the new `@abeta.dev/auth@0.3.0` headless cookie-backed auth client contracts.

## [0.14.2] - 2026-09-17

### Changed
- Normalized monorepo release metadata and pinned the root package to the exact tested `@abeta.dev/auth@0.2.2` artifact.
- Added packed external-consumer verification and publish safeguards that verify or skip immutable versions, publish auth before the root package, and verify registry availability before the root publish.
